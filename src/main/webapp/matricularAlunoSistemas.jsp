...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			$.get("AlunoController", {semestreAjax:semestre}, function(responseText){
				$("#disciplinas").text(responseText);
			});
		});
		});
	</script>	
...
<body>
	...
	<div class="container" id="conteudoPagina">
		...
		<div class="formulario">
			<form action="matricula_sistemas" method="post" class="form-horizontal" role="form"> 
				...
				<p id="" style="text-center; backgroun-color:#dedede"></p>
				
				<div class="form-group">
					<label for="" class="control-label col-sm-2 col-md-4">Disciplinas:</label>
					<div class="col-sm-6 col-md-5" id="disciplinas">
