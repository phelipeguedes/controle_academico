...
<body>		
	...
	<% if(request.getMethod().equalsIgnoreCase("POST") && request.getAttribute("professorLogado") == null){ %>
	...
	<div class="container">
		<form action="loginProfessor" class="form-login" method="post">
			<h4 class="form-signin-heading">Faça o login</h4>
			<label for="nomeUsuario" class="sr-only">Email:</label>
			<input type="email" class="form-control" name="nomeDeUsuario" id="nomeDeUsuario" placeholder="Usuário ou email" required /><br/>
