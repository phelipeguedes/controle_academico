	...
	<div class="container" id="conteudo">
		...
		<section>
			...
			<div class="row">
				<div class="col-md-3 col-lg-3">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>Seja um profissional apto a liderar empresas de qualquer porte, saber atuar na gestão pública ou ser bem-sucedido no próprio negócio.</p>

							<p>Ensinamos a diagnosticar o problema a fim de obter o melhor resultado.</p>
							<br/>
							<a href="pre-matricula-administracao.html"><button class="btn btn-primary" type="button">INSCREVA-SE</button></a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-lg-3">
					<div class="panel panel-default">
						<div class="panel-heading panel-title"><h5>CIÊNCIAS CONTÁBEIS</h5></div>
						<div class="panel-body">
							...
							<a href="pre-matricula-contabeis.html""><button class="btn btn-primary" type="button">INSCREVA-SE</button></a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-lg-3">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<a href="pre-matricula-redes.html""><button class="btn btn-primary" type="button">INSCREVA-SE</button></a>
						</div>
					</div>
				</div>    				
				...
				<div class="col-md-3 col-lg-3">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>O objetivo do curso é capacitar o estudante a desenvolver soluções computacionais para problemas existentes no mundo real.</p>

							<p>Dando-lhe aptidões para projetar, implantar, desenvolver e gerir sistemas de alta qualidade. </p>
							<br/>
							<a href="pre-matricula-sistemas.html"><button class="btn btn-primary" type="button">INSCREVA-SE</button></a>
						</div>
					</div>
