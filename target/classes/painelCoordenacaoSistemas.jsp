...
<body>
	<div id="container">
		...
		<div id="conteudo-barra_lateral">
			...
			<!-- collapse: ao redimensionar a tela, os menus da barra ficam escondidos no botÃ£o -->
				...
				<ul class="sidebar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">ALUNO<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="matricularAlunoSistemas.jsp" target="_blank">MATRÍCULA</a></li>				
				...
				<div class="container-fluid">
					<div class="row"> <!-- row: mantÃ©m os elementos na mesma linha -->
						<div class="col-lg-12 col-md-12">
							...
							<p>
								O setor propõe e coordena atividades de execução dos cursos, preza pela qualidade do ensino, aprendizagem e valores ensinados na instituição. A responsabilidade do coordenador assegurar a integração disciplinar e o acompanhamento dos docentes, no âmbito educacional, mantendo a integridade pedagógica e institucional.
							</p>
							...
							<p>
								<strong>Coordenador Acadêmico:</strong> Cristiano Duarte
								<br/>
