...
<head>
	<meta charset="UTF-8">
	<title>Redes | PrÈ-MatrÌcula</title>
				...
				<ul class="nav navbar-nav" id="nav">
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">ALUNO<span class="caret"></span></a>
						<ul class="dropdown-menu">							
							...
							<li><a href="matricula-online.html" target="blank">MATRÕçCULA</a></li>
	...
	<div class="container">
		<form action="pre_matricula" method="post" class="form-horizontal" role="form">
			...
			<div class="form-group">					
				...
				<div class="col-md-4">
					<input type="text" name="cep" id="cep" class="form-control" placeholder="Somente n˙meros" maxlength="9" required>
				</div>					
			</div>	
			...
			<div class="form-group">					
				...
				<div class="col-md-4">
					<input type="tel" name="telefone" id="telefone" class="form-control" placeholder="Somente n˙meros" maxlength="14" required>
				</div>					
			</div>	
